                                ...
                                {app.atsScore !== null && app.atsScore !== undefined && (
                                    <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                        <div className="flex items-center gap-2 mb-2">
                                            <h4 className="text-sm font-bold text-blue-900">AI ATS Match Score:</h4>
                                            <span className={`px-2 py-1 rounded text-sm font-bold ${app.atsScore >= 80 ? 'bg-green-200 text-green-800' : app.atsScore >= 50 ? 'bg-yellow-200 text-yellow-800' : 'bg-red-200 text-red-800'}`}>
                                                {app.atsScore}%
                                            </span>
                                        </div>
                                        <p className="text-sm text-blue-800">{app.atsFeedback}</p>
                                    </div>
                                )}

                                {/* Quiz Score */}
                                {app.quizScore !== null && app.quizScore !== undefined && (
                                    <div className="mb-4 p-4 bg-purple-50 rounded-lg border border-purple-100 flex items-center justify-between">
                                        <h4 className="text-sm font-bold text-purple-900">Skill Assessment Score:</h4>
                                        <span className={`px-3 py-1 rounded text-sm font-bold ${app.quizScore >= 70 ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'}`}>
                                            {app.quizScore}%
                                        </span>
                                    </div>
                                )}
